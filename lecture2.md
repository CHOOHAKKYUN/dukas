...
여전히 한국보다 유효구인수가 많은 만큼, 취업난이도는 낮은 편이나 대기업이나 급여가 많은 기업의 채용은 난이도가 어느정도 있는 편(상사, 산토리나 소니 같은,,)
...
### 기술스택
- 어떤 언어가 사용 가능한 지 기술하는 정도로 충분 (Python, Java, JS, SQL 등), 기초 기본 중급 고급 4단계로 기술하면 더 좋을 것.
- AWS, Snowflake 같은 SaaS나 협업 툴인 Github, bitbucket도 사용경험이 있으면 なお良い.
